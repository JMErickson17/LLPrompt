...
"""
TODO: 
    - Abstract the UI into a Python class
    - Possibly split UI from LLM to deploy model on GPU
...
def display_table(generated_command: GeneratedCommand):
    ...
    console.print(
        generated_command.command, style="green", justify="center", end="\n\n"
    )

    console.print(generated_command.explanation, end="\n\n")
